...
[![Tests](https://github.com/YOUR_ORG/epspsclass/actions/workflows/tests.yml/badge.svg)](https://github.com/YOUR_ORG/epspsclass/actions)
...
2. **This reimplementation:**
   [Your paper citation here] — EPSPSClass v1.0.0.
   https://github.com/YOUR_ORG/epspsclass
...
# Development install
git clone https://github.com/YOUR_ORG/epspsclass.git
cd epspsclass
pip install -e ".[dev]"
```
...
- **Class III motif completeness:** The 21 triplet motifs were derived
  computationally from the bvEPSPS alignment. The original tool referenced
  18 motifs from Carozzi et al. (2006); the computational derivation yields
  21. Differences reflect the choice of alignment method and gap-filtering
  criteria. Results are validated by correct self-classification of the
  bvEPSPS reference sequence.
...
```groovy
// main.nf
include { EPSPYCLASS_CLASSIFY } from './workflow/modules/epspsclass.nf'

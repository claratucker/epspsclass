...
def cmd_validate_markers(args: argparse.Namespace) -> int:
    ...
    print(f"\nClass III (bvEPSPS, {len(CLASS_III_MOTIFS)} triplet motifs, ≥2 required) — Resistant")
    for i, (p1, a1, p2, a2, p3, a3) in enumerate(CLASS_III_MOTIFS, 1):
        print(f"  Motif {i:2d}: {a1}{p1}-{a2}{p2}-{a3}{p3}")
